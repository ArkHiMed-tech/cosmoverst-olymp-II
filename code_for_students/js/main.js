...
var modWindow = document.getElementById('ask-question');
var buttonOpen = document.getElementById('butt-open');
var buttonClose = document.getElementById('butt-close');

buttonOpen.addEventListener('click', function () {
    modWindow.classList.add('modal--open');
});

buttonClose.addEventListener('click', function () {
    modWindow.classList.remove('modal--open');
});
